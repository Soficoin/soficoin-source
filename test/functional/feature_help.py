...
"""Verify that starting soficoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start soficoin with -h for help text")
        ...
        self.log.info("Start soficoin with -version for version information")
