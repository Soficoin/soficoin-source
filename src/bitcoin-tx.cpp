...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s soficoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  soficoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded soficoin transaction") + "\n" +
              "  soficoin-tx [options] -create [commands]   " + _("Create hex-encoded soficoin transaction") + "\n" +
              "\n";
